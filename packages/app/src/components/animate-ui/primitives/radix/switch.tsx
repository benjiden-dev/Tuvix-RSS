...
function Switch(props: SwitchProps) {
  ...
  // Extract Radix-specific props that shouldn't be passed to motion.button
  // onCheckedChange, checked, and defaultChecked are handled internally
  const { disabled, onCheckedChange, checked, defaultChecked, ...motionProps } =
    props;
