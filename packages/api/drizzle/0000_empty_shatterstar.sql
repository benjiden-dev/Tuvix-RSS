...
('free', 'Free', 500, 2, 200, 60, 2, 0, '{"description": "Perfect for personal use"}', strftime('%s', 'now') * 1000, strftime('%s', 'now') * 1000),
('pro', 'Pro', 2000, 25, 500, 180, 17, 1000, '{"description": "For power users and professionals"}', strftime('%s', 'now') * 1000, strftime('%s', 'now') * 1000),
