...
('free', 'Free', 25, 2, 10, 30, 2, 0, '{"description": "Perfect for personal use"}', strftime('%s', 'now') * 1000, strftime('%s', 'now') * 1000),
('pro', 'Pro', 500, 25, 100, 120, 17, 1000, '{"description": "For power users and professionals"}', strftime('%s', 'now') * 1000, strftime('%s', 'now') * 1000),
