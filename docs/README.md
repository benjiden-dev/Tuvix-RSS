...
├── deployment.md                  # Complete deployment guide (Docker & Cloudflare)
├── trpc-api-architecture.md       # tRPC API architecture reference
├── project-integration.md         # Frontend-backend integration guide
├── public-feed-system.md          # Legacy/alternative public feeds doc (see public-feeds.md)
├── architecture/                  # Architecture and system design documentation
│   ├── polling-and-article-updates.md  # RSS polling and article update system
│   └── usage-quotas-and-time-periods.md # Usage quotas and time period implementation
├── planning/                      # Planning documents and implementation plans
│   └── user-settings-enhancement-plan.md        # User settings enhancement plan
├── developer/                     # Developer reference documentation
│   ├── animated-articles.md       # Animated article list implementation
│   ├── authentication.md         # Authentication system implementation
│   ├── offline-support.md         # Offline support & React Query config
│   ├── public-feeds.md            # Public feeds implementation
│   ├── pwa.md                     # Progressive Web App implementation
│   ├── rate-limiting.md           # Rate limiting system implementation
│   ├── security.md                # Security implementation & best practices
│   └── theme-system.md            # Theme system implementation
└── guides/                       # User guides and tutorials
    └── admin/                     # Admin and operations guides
...
- Password security (scrypt, complexity requirements)
- Rate limiting and brute force protection
- User roles and permissions
- Plan system and resource limits
- Account banning
